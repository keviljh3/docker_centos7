...
killall node
ulimit -n 65535
nohup ./kcps64_170120 -t "0.0.0.0:17520" -l ":17518" -key test -mtu 1350 -sndwnd 1024 -rcvwnd 1024 -crypt none -mode fast2 -dscp 0 -datashard 0 -parityshard 0  -autoexpire 0 -nocomp> kcptun.log 2>&1 &
