...
#cd /fs
sh /fs/restart.sh
nohup python /shadowsocksr-akkariiin-dev/shadowsocks/server.py -p 17520 -k Ssr123456 -m chacha20-ietf -O auth_chain_e -o tls1.2_ticket_auth_compatible -G 32 -g www.yahoo.com > ssr.log 2>&1 &
