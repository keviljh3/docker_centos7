...
nohup python /root/shadowsocksr-akkariiin-dev/shadowsocks/server.py -p 17520 -k Ssr123456 -m chacha20-ietf -O auth_chain_e -o tls1.2_ticket_auth -G 32 -g www.bing.com > ssr.log 2>&1 &
